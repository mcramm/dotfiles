...
let colors_name = "cramm-light"

hi Normal               cterm=NONE              ctermbg=230     ctermfg=16
...
hi Number               cterm=None              ctermbg=NONE    ctermfg=213
...
hi Constant             cterm=None              ctermbg=NONE    ctermfg=213
hi PreProc              cterm=None              ctermfg=NONE
hi Directive            cterm=NONE              ctermbg=NONE    ctermfg=NONE
hi Conditional          cterm=NONE              ctermbg=NONE    ctermfg=95
...
hi Statement            cterm=NONE              ctermbg=NONE    ctermfg=75     " properties in javascript thing: function (thing is colored)
hi Ignore		cterm=bold		ctermfg=NONE
hi String               cterm=NONE              ctermfg=58
