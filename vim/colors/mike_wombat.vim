...
if version >= 700
  hi CursorLine ctermbg=235 guibg=#2d2d2d
...
hi Constant     ctermfg=203 guifg=#e5786d gui=none
hi String       ctermfg=113 guifg=#95e454 gui=italic
hi Identifier   ctermfg=155 guifg=#cae682 gui=none
hi Function     ctermfg=155 guifg=#cae682 gui=none
hi Type         ctermfg=155 guifg=#cae682 gui=none
